      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
        {webinars.map((web, idx) => (
          <div key={idx} className="p-6 bg-purple-950/[0.02] border border-purple-900/10 rounded-xl flex flex-col justify-between space-y-5 shadow-sm hover:border-purple-900/30 transition-all duration-300 group">
            ...
            <Link href="/contacts" className="inline-flex items-center justify-center gap-1.5 border-2 border-red-600 bg-white hover:bg-red-600 text-red-700 hover:text-white font-bold text-[13px] uppercase tracking-widest px-5 py-3 rounded-lg transition-all font-mono shadow-sm group/btn">
