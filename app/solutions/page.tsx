  ...
  return (
    <div className="pt-24 md:pt-28 pb-24 px-4 sm:px-6 md:px-0 lg:px-margin-desktop max-w-[1536px] mx-auto space-y-20 w-full bg-white text-zinc-900 antialiased">
      ...
      <div className="border-b border-zinc-200 pb-8 max-w-4xl text-left">
        <span className="text-[15px] font-mono font-black tracking-widest text-red-700 uppercase bg-purple-950/[0.04] border border-purple-900/10 px-3 py-1 rounded w-fit block mb-4">
          Cybersecurity Solutions Matrix
        </span>
        <h1 className="text-3xl md:text-5xl font-extrabold text-zinc-900 tracking-tight uppercase mb-4 leading-none">
          Professional Solutions
        </h1>
        <p className="text-zinc-600 text-[15px] md:text-[17px] leading-relaxed font-normal">
      ...
      <section className="space-y-8 text-left">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-100 pb-3">
          ...
          <button 
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-bold text-[15px] uppercase tracking-widest px-5 py-3 rounded-md transition-all font-mono text-center"
          >
            ...
            <div key={idx} className="bg-zinc-950 text-white rounded-xl p-8 border border-zinc-800 flex flex-col justify-between space-y-6 shadow-2xl relative overflow-hidden group">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-[15px] font-bold text-red-500 uppercase tracking-widest mt-0.5 font-mono">{prod.tagline}</p>
                </div>
                <p className="text-zinc-300 text-[11px] md:text-[15px] leading-relaxed font-normal">{prod.desc}</p>
              </div>
              <Link href={prod.path} className="inline-flex items-center gap-2 text-[15px] font-bold uppercase tracking-widest text-red-500 hover:text-white transition-colors pt-2 self-start font-mono group">
            ...
            return (
              <div key={idx} className="bg-purple-950/[0.02] border border-purple-900/10 rounded-xl p-6 flex flex-col justify-between space-y-6 shadow-sm hover:border-purple-900/30 transition-all duration-300 group">
                <div className="space-y-4">
                  ...
                  <h3 className="text-[15px] font-bold text-zinc-900 group-hover:text-red-700 transition-colors uppercase tracking-tight">
                    {srv.title}
                  </h3>
