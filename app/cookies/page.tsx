    ...
    <div className="pt-24 md:pt-28 pb-24 px-4 sm:px-6 md:px-0 lg:px-margin-desktop max-w-[1536px] mx-auto bg-white text-zinc-900 antialiased">
      <div className="max-w-3xl text-left space-y-10">
        ...
        <div className="border-b border-zinc-200 pb-8">
          ...
          <h1 className="text-2xl md:text-4xl font-extrabold tracking-tight text-zinc-900 uppercase mb-4">Cookie Policy</h1>
        ...
        <section className="space-y-4">
          <h2 className="text-[16px] font-bold text-zinc-900 uppercase tracking-tight">What Are Cookies?</h2>
        ...
        {/* Why We Use Cookies */}
        <section className="space-y-4">
          <h2 className="text-[16px] font-bold text-zinc-900 uppercase tracking-tight">Why Do We Use Cookies?</h2>
          <p className="text-[14px] text-zinc-600 leading-relaxed">
        ...
        <section className="space-y-6">
          <h2 className="text-[16px] font-bold text-zinc-900 uppercase tracking-tight">Types of Cookies We Use</h2>

          <div className="space-y-2">
            <h3 className="text-[14px] font-bold text-zinc-900 uppercase tracking-tight">Essential Website Cookies</h3>
            <p className="text-[14px] text-zinc-600 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 className="text-[14px] font-bold text-zinc-900 uppercase tracking-tight">Performance and Functionality Cookies</h3>
            <p className="text-[14px] text-zinc-600 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 className="text-[14px] font-bold text-zinc-900 uppercase tracking-tight">Analytics and Customization Cookies</h3>
            <p className="text-[14px] text-zinc-600 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 className="text-[14px] font-bold text-zinc-900 uppercase tracking-tight">Advertising Cookies</h3>
            <p className="text-[14px] text-zinc-600 leading-relaxed">
          ...
          <div className="space-y-2">
            <h3 className="text-[14px] font-bold text-zinc-900 uppercase tracking-tight">Social Media Cookies</h3>
            <p className="text-[14px] text-zinc-600 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-[16px] font-bold text-zinc-900 uppercase tracking-tight">How Can You Control Cookies?</h2>
          <p className="text-[14px] text-zinc-600 leading-relaxed">
        ...
        {/* Web Beacons */}
        <section className="space-y-4">
          <h2 className="text-[16px] font-bold text-zinc-900 uppercase tracking-tight">Do We Use Web Beacons?</h2>
          <p className="text-[14px] text-zinc-600 leading-relaxed">
        ...
        {/* Updates */}
        <section className="space-y-4">
          <h2 className="text-[16px] font-bold text-zinc-900 uppercase tracking-tight">How Often Will We Update This Cookie Policy?</h2>
          <p className="text-[14px] text-zinc-600 leading-relaxed">
        ...
        {/* Contact */}
        <section className="space-y-4">
          <h2 className="text-[16px] font-bold text-zinc-900 uppercase tracking-tight">Where Can You Get Further Information?</h2>
          <p className="text-[14px] text-zinc-600 leading-relaxed">
