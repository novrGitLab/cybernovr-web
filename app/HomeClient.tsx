          ...
          <div className="relative z-10 max-w-[1536px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-3 flex justify-center lg:justify-start opacity-0 animate-[bannerFadeScale_0.6s_ease-out_0.1s_forwards]">
              <Image
                ...
                alt="ISO 27001 Certified Cybersecurity Company Nigeria"
                width={220}
                height={208}
              ...
              <div className="space-y-4">
                ...
                <div className="h-16 w-full flex items-center justify-start border-b border-zinc-100 pb-2">
                  <Image
                    ...
                    alt={`${sol.name} — CyberNovr solution logo`}
                    width={160}
                    height={48}
            ...
            <div className="flex space-x-16 animate-marqueeLeftToRight min-w-full shrink-0 items-center justify-around">
              {partners.concat(partners).map((partner, i) => (
                <Image
                  ...
                  alt={`Technology partner ${partner} — CyberNovr`}
                  width={140}
                  height={40}
                  loading="lazy"
            ...
            <div className="flex flex-col lg:flex-row h-full min-h-[420px]">
              ...
              <div className="lg:w-[55%] relative overflow-hidden bg-[#0c1222]">
                ...
                >
                  <Image
                    src="/assets/iso/iso-27001.webp"
                    alt="ISO 27001 Certified — CyberNovr Information Security Management"
                    width={640}
                    height={606}
