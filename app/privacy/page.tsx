    ...
    <div className="pt-24 md:pt-28 pb-24 px-4 sm:px-6 md:px-0 lg:px-margin-desktop max-w-[1536px] mx-auto bg-white text-zinc-900 antialiased">
      <div className="max-w-3xl text-left space-y-10">
        ...
        <div className="border-b border-zinc-200 pb-8">
          ...
          <p className="text-zinc-500 text-[13px] font-medium">Last updated: May 18, 2025</p>
        </div>

        {/* Intro */}
        <section className="space-y-4 text-[13px] text-zinc-600 leading-relaxed">
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">Consent</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">Information We Collect</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">How We Use Your Information</h2>
          <ul className="list-disc pl-5 text-[13px] text-zinc-600 leading-relaxed space-y-2">
        ...
        {/* Log Files */}
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">Log Files</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        {/* Data Retention */}
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">How Long Do We Keep the Information We Collect?</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">Advertising Partners Privacy Policies</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">Third Party Privacy Policies</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        {/* GDPR */}
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">GDPR Data Protection Rights</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
            We would like to make sure you are fully aware of all of your data protection rights. Every user is entitled to the following:
          </p>
          <ul className="list-disc list-inside text-[13px] text-zinc-600 leading-relaxed space-y-2">
        ...
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">Children&apos;s Information</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        {/* Contact */}
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">How to Contact Us</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        {/* Changes */}
        <section className="space-y-4">
          <h2 className="text-[15px] font-bold text-zinc-900 uppercase tracking-tight">Changes to the Policy</h2>
          <p className="text-[13px] text-zinc-600 leading-relaxed">
        ...
        <div className="pt-6 border-t border-zinc-200">
          <Link href="/" className="text-red-700 hover:text-red-600 font-bold uppercase text-[13px] tracking-widest font-mono">
            &larr; Back to Home
          </Link>
        </div>
