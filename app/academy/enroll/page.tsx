    ...
    <div className="pt-24 md:pt-28 pb-24 px-4 sm:px-6 md:px-0 lg:px-margin-desktop max-w-[1536px] mx-auto bg-white text-zinc-900 antialiased">
      <div className="max-w-3xl text-left space-y-10">
        ...
        <div className="bg-purple-950/[0.04] border border-purple-900/10 p-5 rounded-xl">
          <p className="text-sm font-bold text-zinc-900 uppercase tracking-tight mb-1">Important Notice</p>
          <p className="text-sm text-zinc-600 leading-relaxed">
            Enrollment and payment processing are handled through our dedicated academy portal. Please read all instructions carefully before proceeding.
          </p>
        </div>
          ...
          {steps.map((step) => (
            <div key={step.num} className="flex gap-5">
              ...
              <div className="space-y-2">
                <h2 className="text-lg font-bold text-zinc-900 uppercase tracking-tight">{step.title}</h2>
                ...
                <p className="text-xs text-zinc-400 font-medium flex items-center gap-1.5">
                  <CheckCircle2 className="h-3.5 w-3.5 text-red-600" /> {step.detail}
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="border-t border-zinc-200 pt-8 space-y-4">
          <h2 className="text-lg font-bold text-zinc-900 uppercase tracking-tight">Need Assistance?</h2>
          <p className="text-sm text-zinc-600 leading-relaxed">
            If you get lost at any step of the way or encounter issues during enrollment, please don&apos;t hesitate to{' '}
            <Link href="/contacts" className="text-red-700 hover:underline font-bold">contact</Link> our support team.
          </p>
          <div className="text-sm text-zinc-600 space-y-2">
            <p className="flex items-center gap-2"><Mail className="h-4 w-4 text-red-600" /> <strong>Email Support:</strong> <a href="mailto:info@cybernovr.com" className="text-red-700 hover:underline font-bold">info@cybernovr.com</a></p>
            <p className="flex items-center gap-2"><Phone className="h-4 w-4 text-red-600" /> <strong>Phone Support:</strong> <a href="tel:+2348143788857" className="text-red-700 hover:underline font-bold">+234 814-378-8857</a></p>
            <p className="flex items-center gap-2"><Clock className="h-4 w-4 text-red-600" /> <strong>Hours:</strong> Monday - Friday, 9:00 AM - 6:00 PM WAT</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          ...
          >
            <BookOpen className="h-4 w-4" /> Go to Academy Portal <ArrowRight className="h-4 w-4" />
          </a>
          <Link
            href="/academy"
