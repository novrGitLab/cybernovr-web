...
export default function CybernovrAcademyPage() {
  ...
  // Mapped from the corporate profile training documentation
  const courseModules = [
    {
      num: "01",
      title: "Introduction to Critical Infrastructure Protection",
      topic: "Sovereign Asset Architecture",
    },
    {
      num: "02",
      title: "Fundamentals of Network Security & Defense Layers",
      topic: "Perimeter Defenses",
    },
    {
      num: "03",
      title: "Understanding GRC and Automated Frameworks",
      topic: "NovrGRC Foundations",
    },
    {
      num: "04",
      title: "Threat Vector Analysis & Exposure Metrics",
      topic: "SecuBreach Systems",
    },
    {
      num: "05",
      title: "Vulnerability Discovery & CVE Index Mapping",
      topic: "Threat Hunting Labs",
    },
    {
      num: "06",
      title: "Hands-on Ethical Hacking Foundations",
      topic: "Sandboxed Lab Protocols",
    },
    {
      num: "07",
      title: "Incident Response Frameworks & Containment",
      topic: "Rapid Tactical Action",
    },
    {
      num: "08",
      title: "Digital Forensics & Incident Post-Mortems",
      topic: "Anomaly Diagnostics",
    },
    {
      num: "09",
      title: "Data Protection & Regional Privacy Regulations",
      topic: "NDPC & GDPR Compliance",
    },
    {
      num: "10",
      title: "AI Governance & Deep Learning Threat Intelligence",
      topic: "Next-Gen Heuristics",
    },
  ];
  ...
  return (
    <div className="pt-32 md:pt-40 pb-section-gap px-margin-desktop max-w-[1536px] mx-auto space-y-20">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center border-b border-outline-variant/20 pb-12">
        <div className="lg:col-span-8 space-y-4">
          ...
          <p className="italic text-primary border-l-4 border-primary pl-6 py-1 text-lg md:text-xl font-bold">
            Flagship education program delivering hands-on technical training
            frameworks.
          </p>
          <p className="text-on-surface-variant text-sm md:text-base max-w-2xl leading-relaxed pt-2">
            Our specialized academy delivers institutional-grade cyber training
            designed to build real-world resilience. Featuring comprehensive
            modules with integrated hands-on ethical hacking labs, we ensure
            that students gain direct exposure to elite perimeter preservation
            tools.
          </p>
        </div>

        {/* Metric Overview Callout Box (Mapped to look like image_fd8e81.png layouts) */}
        <div className="lg:col-span-4 bg-primary text-white p-8 rounded-xl shadow-xl flex flex-col justify-between space-y-6">
          <div>
            ...
            <h3 className="text-xl font-black uppercase tracking-wide mt-4">
              Academy Footprint
            </h3>
            <p className="text-xs text-white/80 mt-1 leading-relaxed">
              Delivering national cybersecurity technical leadership training
              tracks across critical public and private secondary sectors.
            </p>
          </div>
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          <h2 className="text-2xl md:text-3xl font-extrabold text-on-surface tracking-tight">
            Technical Curriculum Matrix
          </h2>
          <p className="text-sm text-on-surface-variant max-w-xl">
            A comprehensive, multi-module framework covering operational
            parameters from asset protection to compliance analytics.
          </p>
        </div>

        {/* Dense Grid List of Modules */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {courseModules.map((mod, idx) => (
            <div
              key={idx}
              className="p-5 bg-white border border-outline-variant/30 rounded-lg flex items-start gap-4 hover:border-primary/40 transition-all shadow-sm"
            >
      ...
      {/* Cyberpunk Style Interactive Lab Feature Panel */}
      <section className="bg-inverse-surface text-white rounded-xl overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-12">
        <div className="lg:w-7/12 p-8 md:p-12 flex flex-col justify-center space-y-4">
          ...
          <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tight">
            Hands-On Ethical Hacking Lab
          </h3>
          <p className="text-sm text-white/70 leading-relaxed max-w-xl">
            Students learn defensive engineering principles through supervised
            mock infiltration scripts. Safely evaluate malware profiles, analyze
            real-time payload extractions, and configure zero-touch automated
            firewalls inside sandbox networks built for security research.
          </p>
        </div>
        <div className="lg:w-5/12 bg-black/40 p-8 flex items-center justify-center border-t lg:border-t-0 lg:border-l border-white/10">
          <div className="w-full max-w-sm bg-black/60 font-mono text-xs p-5 rounded-lg border border-white/10 shadow-inner space-y-2 text-primary">
            <p className="text-white/40">
              // INITIALIZING SECURITY EDUCATION PROTOCOL...
            </p>
            <p className="text-white">&gt; run ceap --sandbox-mode</p>
            <p className="text-green-400">
              ✔ Lab Environment Connected Successfully
            </p>
            <p className="text-white">&gt; check --vulnerability-matrix</p>
            <p className="text-amber-400">
              ⚠️ 3 Exposed Assets Prioritized for Compliance Remediation
            </p>
            <div className="w-full bg-white/5 h-1.5 rounded overflow-hidden pt-1">
      ...
      <section className="bg-white border border-outline-variant/30 rounded-xl p-8 md:p-12 max-w-3xl mx-auto shadow-sm">
        <div className="text-center space-y-2 mb-8">
          <h2 className="text-2xl font-extrabold tracking-tight text-on-surface">
            Initiate Academy Enrollment
          </h2>
          <p className="text-xs md:text-sm text-on-surface-variant max-w-md mx-auto">
            Submit your parameters below to enlist your institution or register
            individual student tracking accounts.
          </p>
        </div>
        ...
        {enrollmentSubmitted ? (
          <div className="p-8 text-center bg-primary/5 border border-primary/20 rounded-lg space-y-2">
            ...
            <h4 className="text-base font-bold text-on-surface uppercase tracking-wide">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <input
                className="w-full bg-surface border border-outline-variant/30 rounded px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all"
                placeholder="Institutional / Academic Email"
                type="email"
                required
              />
            </div>
